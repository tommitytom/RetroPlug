...
// Missing-file detection / relink moved to shared TS (@retroplug/retroplug
// missingFiles.ts); scanMissingFiles / relinkInConfig / autoFindSiblings are now
// unit-tested in test/ts/project/missing_files.test.ts. Only sanitizeSavTargets
// stays native (the DAW setState path) — see ProjectMissingFiles.hpp.
