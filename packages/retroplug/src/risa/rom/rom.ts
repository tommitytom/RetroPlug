...
// table is located by a 6-byte magic scan within the fixed bank; the CHR font slots are position-
// deterministic (chrOffset + slot*0x2000). Kits (the 32 DPCM banks) are deferred to M5.
