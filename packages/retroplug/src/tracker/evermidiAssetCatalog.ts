...
// of ./risaAssetCatalog.ts. EverMIDI bakes one theme + one CHR font slot; the DMC kit is single-slot on NROM
...
export const evermidiAssetCatalog: AssetCatalog = {
  ...
  resolveTypes(romBytes: Uint8Array): AssetTypeInfo[] {
    ...
    return [THEME_TYPE, kitType(rom.isEverMidi ? rom.kitBankCapacity() : 1), FONT_TYPE];
  },
