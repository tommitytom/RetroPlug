...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=RetroPlug Demo Installer\n"
      else:
        line="OutputBaseFilename=RetroPlug Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the RetroPlug Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the RetroPlug installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=RetroPlug Demo installer\n"
     else:
       line="SetupWindowTitle=RetroPlug installer\n"
