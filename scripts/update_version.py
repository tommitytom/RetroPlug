...
def main():
  ...
  plistpath = scriptpath + "/resources/RetroPlug-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RetroPlug-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RetroPlug-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RetroPlug-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RetroPlug-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/RetroPlug.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/RetroPlug.iss",inplace=1):
