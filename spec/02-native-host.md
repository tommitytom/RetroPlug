...
| `setAudioRouting` | `(uint32 mode) → bool` | gated `mode ≤ 5` (Stereo / TwoPerInstance / OnePerInstance / ChannelSplit / PinSplit / StereoPinSplit) ([`:321`](../packages/native/src/host/rpc/EngineRpcService.cpp#L321)) |
