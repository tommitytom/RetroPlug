...
namespace rp {
	...
	public:
		void process(fw::AudioBuffer& out, const GainComponent& comp, EmptyTag&) override {
	...
	public:
		void process(fw::AudioBuffer& buffer, const BiquadComponent& comp, BiquadStateComponent& state) override {
			using SampleType = fw::AudioBuffer::SampleTypeT;
