...
void SameBoySystem::loadSram(const Uint8Buffer* sramBuffer, bool reset) {
...
bool SameBoySystem::loadState(const Uint8Buffer* stateBuffer) {
	return GB_load_state_from_buffer(_state.gb, stateBuffer->data(), stateBuffer->size()) == 1;
}
