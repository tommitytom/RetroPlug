...
//	using namespace std::placeholders;
	...
	public:
		...
		void onInitialize() override {
			...
			TextureHandle knobTexture1 = getResourceManager().load<Texture>("C:\\projects\\code\\RetroPlug\\thirdparty\\orb\\resources\\textures\\knob-M.png");
			TextureHandle knobTexture2 = getResourceManager().load<Texture>("C:\\projects\\code\\RetroPlug\\thirdparty\\orb\\resources\\textures\\knob-M2.png");
			TextureHandle knobTexture3 = getResourceManager().load<Texture>("C:\\projects\\code\\RetroPlug\\thirdparty\\orb\\resources\\textures\\knob-M3.png");
			TextureHandle upTexture = getResourceManager().load<Texture>("C:\\projects\\code\\RetroPlug\\thirdparty\\orb\\resources\\textures\\up.png");
